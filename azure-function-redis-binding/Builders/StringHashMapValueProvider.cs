...
{
	public class StringHashMapValueProvider : IValueProvider
	{
        private readonly string _connection;
        private readonly string _key;

		public StringHashMapValueProvider(string connectionName, string key, IConfiguration confiuguration)
		{
